...
const LINKS = [
  ...
  { href: "/exercises", label: "Exercícios", eyebrow: "03" },
  { href: "/flashcards", label: "Flashcards", eyebrow: "04" },
  { href: "/review", label: "Revisão", eyebrow: "05" },
  { href: "/conversation", label: "Conversação", eyebrow: "06" },
];
